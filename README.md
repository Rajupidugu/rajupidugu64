...
- **Description:** Performed manual vulnerability analysis and brute-force testing using Burp Suite and Hydra.
- **Tools:** Burp Suite Community Edition, THC-Hydra.
- **Key Skill:** Successfully intercepted and analyzed `/login` request/response traffic.
- **Evidence:** [📄 View Pentest analysis PDF Proof](./Pentest_analysis.pdf)
